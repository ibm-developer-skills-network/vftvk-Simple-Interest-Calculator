...
//to calculate interest on click function compute
function compute()
{
    //check for negative and zero principal value
    var principal = document.getElementById("principal").value;
   if(principal<=0){
       //clear the previous result and give alert
...
//function to update span with rate slider
function updateRate() 
{
